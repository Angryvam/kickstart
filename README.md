...
First of all, make sure [docker is correctly installed on your Linux/Windows10/MacOS desktop](doc/installing-docker.md) or follow our [german introduction](doc/).
